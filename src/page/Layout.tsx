  ...
  return (
    <div className="flex justify-center items-center my-6 lg:my-0 h-[100vh] w-full">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 h-[fit] w-[80%] mx-auto">
              ...
              <div className="py-9 px-6 lg:px-12 lg:py-16">
                <div className="flex flex-col w-full justify-center items-center gap-y-3 lg:gap-y-7">
                  ...
                  <button
                    ...
                    onClick={() => {setTab(card.tab); handleOpen()}}
                  >
                    open
                  </button>
                </div>
        ...
        <div onClick={handleClose} className={`fixed h-screen left-0 bg-black/80 w-full  z-10 ${isOpen ? 'top-[0%]':'-top-[100%]'}`} ></div>

      <div
        className={`${isOpen ? 'top-[8%]':'-top-[100%]'} z-40 fixed duration-300 shadow-lg overflow-hidden ease-in-out`}>
       <StyledChat>
          <div className="intr">
